...
module.exports = {
    ...
    async execute(interaction,lang,fields) {
        ...
        .setDescription(`You have been warned in ${interaction.guild.name}. This is your ${warnCount}th warn. Be careful what you say or do in this server. If you continue to break server's rules admin could be take more severe actions against you. \n ***If you think this was wrong warn please contact an admin!***`)
