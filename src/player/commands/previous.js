module.exports = {
	...
	async execute(interaction,player,lang,voiceChannel) { 
        var stringPrevious= lang.get(interaction.guild.settings.lang).commands.player.commands["previousSong"]
        var stringErr = lang.get(interaction.guild.settings.lang).commands.player.commands.errors["previousSong"] 
