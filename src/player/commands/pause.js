module.exports = {
	...
	async execute(interaction,player,lang,voiceChannel) {
        var stringPause= lang.get(interaction.guild.lang).commands.player.states["paused"]
        var stringErr = lang.get(interaction.guild.lang).commands.player.states.errors["paused"]
