module.exports = {
	...
	async execute(interaction,player,lang,voiceChannel) {
        var stringPause= lang.get(interaction.guild.settings.lang).player.commands["paused"]
        var stringErr = lang.get(interaction.guild.settings.lang).player.commands.errors["paused"]
