module.exports = {
	...
	async execute(interaction,player,lang,voiceChannel) {
		...
		var stringerr = lang.get(interaction.guild.settings.lang).commands.player.commands.errors["leave"]
		var stringjoin = lang.get(interaction.guild.settings.lang).commands.player.commands["leave"]
		var found = false
