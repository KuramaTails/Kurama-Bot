...
module.exports = {
	async execute(interaction,lang,category) {
        ...
        newButtons.addComponents(
            new MessageButton()
            .setCustomId(`help-Up`)
            .setLabel(`🔼 `+lang.get(interaction.guild.settings.lang).commands.help.buttons["btnPageUp"])
            .setStyle("PRIMARY")
            .setDisabled(true)
        );
        newButtons.addComponents(
            ...
            .setLabel(`🔽 `+lang.get(interaction.guild.settings.lang).commands.help.buttons["btnPageDown"])
            .setStyle("PRIMARY")
            .setDisabled(true)
        );
		switch (category) {
