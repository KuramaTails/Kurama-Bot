        ...
        switch (true) {
            case selectGuildWelcomer[0].activeWelcome == true:
                ...
                button1.addComponents(
                    new MessageButton()
                    .setCustomId(`settings-welcomer-disableWelcomer`)
                ...
                switch (true) {
                    case selectGuildWelcomer[0].activeLeave == false:
                        ...
                        buttonLeaver.addComponents(
                            new MessageButton()
                            .setCustomId(`settings-welcomer-enableLeaver`)
                    ...
                    default:
                        ...
                        buttonLeaver.addComponents(
                            new MessageButton()
                            .setCustomId(`settings-welcomer-disableLeaver`)
                        ...
                        buttonLeavertext.addComponents(
                            new MessageButton()
                            .setCustomId(`settings-welcomer-textLeaver`)
            ...
            case selectGuildWelcomer[0].activeWelcome == false:
                ...
                button1.addComponents(
                    new MessageButton()
                    .setCustomId(`settings-welcomer-enableWelcomer`)
